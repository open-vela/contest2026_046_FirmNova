...
#ifdef DISABLE_MEM_USAGE
#define add_mem_usage(pmem_table, ptr, size, used_num, flag)
#define del_mem_usage(pmem_table, ptr, used_num, flag)
#define get_mem_usage(pmem_table)
#else
/**
