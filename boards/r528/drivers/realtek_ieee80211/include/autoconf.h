...
#if (defined(RX_AGGREGATION) || defined(CONFIG_RECV_REORDERING_CTRL))&&!RX_AGGREGATION && CONFIG_RECV_REORDERING_CTRL
...
/* For DM support */
	...
	#endif
#else
	#if (defined(RTW_HALMAC)&&RTW_HALMAC) || (defined(LOAD_FW_HEADER_FROM_DRIVER)&&LOAD_FW_HEADER_FROM_DRIVER) || (defined(RTW_HALMAC_SIZE_OPTIMIZATION)&&RTW_HALMAC_SIZE_OPTIMIZATION) || SUPPORT_5G_CHANNEL
...
/* For PS */
	...
	#endif
#else
	#if (defined(CONFIG_IPS)&&CONFIG_IPS) || (defined(CONFIG_LPS)&&CONFIG_LPS)
		#error "CONFIG_POWER_SAVING has not been defined, define CONFIG_POWER_SAVING firstly"
	#endif
#endif
#if defined(CONFIG_LPS) && !CONFIG_LPS && defined(CONFIG_LPS_LCLK) && CONFIG_LPS_LCLK
	#error "CONFIG_LPS has not been defined, define CONFIG_LPS firstly"
#endif
#if defined(CONFIG_LPS) && !CONFIG_LPS_LCLK && defined(CONFIG_DETECT_CPWM_BY_POLLING) && CONFIG_DETECT_CPWM_BY_POLLING
...
// enable 1X code in lib_wlan as default (increase 380 bytes)
	...
	#endif
#else
	#if (defined(EAP_MSCHAPv2) && EAP_MSCHAPv2) || (defined(EAP_TTLS_MSCHAPv2) && EAP_TTLS_MSCHAPv2)
...
#define USER_AP_STA_NUM							g_user_ap_sta_num
	...
	#endif
#endif
#if !CONFIG_INTERRUPT_BASED_TXBCN && defined(CONFIG_INTERRUPT_BASED_TXBCN_BCN_OK_ERR) && CONFIG_INTERRUPT_BASED_TXBCN_BCN_OK_ERR
...
/* For MP_MODE */
	...
	#endif
#else
	#if (defined(CONFIG_SUSPEND) && CONFIG_SUSPEND) || (defined(CONFIG_RTW_SDIO_KEEP_IRQ) && CONFIG_RTW_SDIO_KEEP_IRQ) || (defined(CONFIG_GPIO_WAKEUP) && CONFIG_GPIO_WAKEUP) || (defined(CONFIG_WOWLAN_AWAKE_PATTERN) && CONFIG_WOWLAN_AWAKE_PATTERN)
 ...
 */
	...
	#if defined(CONFIG_USB_TX_NUM_ENABLE) && CONFIG_USB_TX_NUM_ENABLE
 ...
 */
	...
	#endif
#else
	#if (defined(CONFIG_BT_MAILBOX) && CONFIG_BT_MAILBOX) ||(defined(CONFIG_BT_EFUSE) && CONFIG_BT_EFUSE) || (defined(CONFIG_BT_TWO_ANTENNA)&&CONFIG_BT_TWO_ANTENNA)
