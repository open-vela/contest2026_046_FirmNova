...
#define sec_info(fmt,args...)	printf(fmt ,##args)
#define sec_err(fmt,args...)   printf(fmt ,##args)
#else
#define sec_info(fmt,args...)	_info(fmt ,##args)
#define sec_err(fmt,args...)   _err(fmt ,##args)
#endif
