...
#define AD_CEDAR_CTRL_FLAG_BUILD_OPUSHDR (1<<8)
...
#define ADEC_AAC            AAC
#define ADEC_APE            APE
#define ADEC_COOK           COOK
#define ADEC_SIPR           SIPR
#define ADEC_ATRC           ATRC
#define ADEC_OGG            OGG
#define ADEC_WAV            WAV
#define ADEC_AMR            AMR
#define ADEC_FLAC           FLAC
#define ADEC_MP3            MP3
#define ADEC_RA             RA
#define ADEC_ALAC           ALAC
#define ADEC_G729           G729
#define ADEC_Opus           Opus
#define ADEC_WV             WV
...
#define ADEC_APE_INIT_FUNC  ADEC_FUNC_NAME(ADEC_APE, ADEC_INIT_SUFFIX) //"AudioAPEDecInit"
#define ADEC_APE_EXIT_FUNC  ADEC_FUNC_NAME(ADEC_APE, ADEC_EXIT_SUFFIX) //"AudioAPEDecExit"
#define ADEC_COOK_INIT_FUNC  ADEC_FUNC_NAME(ADEC_COOK, ADEC_INIT_SUFFIX) //"AudioCOOKDecInit"
#define ADEC_COOK_EXIT_FUNC  ADEC_FUNC_NAME(ADEC_COOK, ADEC_EXIT_SUFFIX) //"AudioCOOKDecExit"
#define ADEC_SIPR_INIT_FUNC  ADEC_FUNC_NAME(ADEC_SIPR, ADEC_INIT_SUFFIX) //"AudioSIPRDecInit"
#define ADEC_SIPR_EXIT_FUNC  ADEC_FUNC_NAME(ADEC_SIPR, ADEC_EXIT_SUFFIX) //"AudioSIPRDecExit"
#define ADEC_ATRC_INIT_FUNC  ADEC_FUNC_NAME(ADEC_ATRC, ADEC_INIT_SUFFIX) //"AudioATRCDecInit"
#define ADEC_ATRC_EXIT_FUNC  ADEC_FUNC_NAME(ADEC_ATRC, ADEC_EXIT_SUFFIX) //"AudioATRCDecExit"
#define ADEC_OGG_INIT_FUNC  ADEC_FUNC_NAME(ADEC_OGG, ADEC_INIT_SUFFIX) //"AudioOGGDecInit"
#define ADEC_OGG_EXIT_FUNC  ADEC_FUNC_NAME(ADEC_OGG, ADEC_EXIT_SUFFIX) //"AudioOGGDecExit"
...
#define ADEC_AMR_INIT_FUNC  ADEC_FUNC_NAME(ADEC_AMR, ADEC_INIT_SUFFIX) //"AudioAMRDecInit",
#define ADEC_AMR_EXIT_FUNC  ADEC_FUNC_NAME(ADEC_AMR, ADEC_EXIT_SUFFIX) //"AudioAMRDecExit",
#define ADEC_FLAC_INIT_FUNC  ADEC_FUNC_NAME(ADEC_FLAC, ADEC_INIT_SUFFIX) //"AudioFLACDecInit",
#define ADEC_FLAC_EXIT_FUNC  ADEC_FUNC_NAME(ADEC_FLAC, ADEC_EXIT_SUFFIX) //"AudioFLACDecExit",
...
#define ADEC_RA_INIT_FUNC  ADEC_FUNC_NAME(ADEC_RA, ADEC_INIT_SUFFIX) //"AudioRADecInit",
#define ADEC_RA_EXIT_FUNC  ADEC_FUNC_NAME(ADEC_RA, ADEC_EXIT_SUFFIX) //"AudioRADecExit",
#define ADEC_ALAC_INIT_FUNC  ADEC_FUNC_NAME(ADEC_ALAC, ADEC_INIT_SUFFIX) //"AudioALACDecInit",
#define ADEC_ALAC_EXIT_FUNC  ADEC_FUNC_NAME(ADEC_ALAC, ADEC_EXIT_SUFFIX) //"AudioALACDecExit",
#define ADEC_G729_INIT_FUNC  ADEC_FUNC_NAME(ADEC_G729, ADEC_INIT_SUFFIX) //"AudioG729DecInit",
#define ADEC_G729_EXIT_FUNC  ADEC_FUNC_NAME(ADEC_G729, ADEC_EXIT_SUFFIX) //"AudioG729DecExit",
#define ADEC_Opus_INIT_FUNC  ADEC_FUNC_NAME(ADEC_Opus, ADEC_INIT_SUFFIX) //"AudioOpusDecInit",
#define ADEC_Opus_EXIT_FUNC  ADEC_FUNC_NAME(ADEC_Opus, ADEC_EXIT_SUFFIX) //"AudioOpusDecExit",
#define ADEC_WV_INIT_FUNC  ADEC_FUNC_NAME(ADEC_WV, ADEC_INIT_SUFFIX) //"AudioWVDecInit",
#define ADEC_WV_EXIT_FUNC  ADEC_FUNC_NAME(ADEC_WV, ADEC_EXIT_SUFFIX) //"AudioWVDecExit",
...
#if defined(AUTH_T)
InitCodecInfo InitDolbyDecT = {
    .handle = "libddpdec.so",
    .name   = "cedardolby",
    .init   = "AudioDolbyDecInit",
    .exit   = "AudioDolbyDecExit",
    .flag   = AD_CEDAR_CTRL_FLAG_BUILD_COMMONHDR,
};
#else
InitCodecInfo InitDolbyPassThru = {
    .handle = "libpassthrua.so",
    .name   = "cedarpassthrua",
    .init   = "passthruaDecInit",
    .exit   = "passthruaDecExit",
    .flag   = 0,
};
#endif

InitCodecInfo InitDtsPassThru = {
    .handle = "libpassthrud.so",
    .name   = "cedarpassthrud",
    .init   = "passthrudDecInit",
    .exit   = "passthrudDecExit",
    .flag   = 0,
};
#if 1
...
InitCodecInfo InitApeDecT = {
    ...
    .name   = "cedarape",
    .init   = STRING(ADEC_APE_INIT_FUNC), //"AudioAPEDecInit",
    .exit   = STRING(ADEC_APE_EXIT_FUNC), //"AudioAPEDecExit",
...
InitCodecInfo InitCookDecT = {
    ...
    .name   = "cedarcook",
    .init   = STRING(ADEC_COOK_INIT_FUNC), //"AudioCOOKDecInit",
    .exit   = STRING(ADEC_COOK_EXIT_FUNC), //"AudioCOOKDecExit",
...
InitCodecInfo InitSiprDecT = {
    ...
    .name   = "cedarsipr",
    .init   = STRING(ADEC_SIPR_INIT_FUNC), //"AudioSIPRDecInit",
    .exit   = STRING(ADEC_SIPR_EXIT_FUNC), //"AudioSIPRDecExit",
...
InitCodecInfo InitAtrcDecT = {
    ...
    .name   = "cedaratrc",
    .init   = STRING(ADEC_ATRC_INIT_FUNC), //"AudioATRCDecInit",
    .exit   = STRING(ADEC_ATRC_EXIT_FUNC), //"AudioATRCDecExit",
    .flag   = AD_CEDAR_CTRL_FLAG_BUILD_RAHDR,
};
InitCodecInfo InitOggDecT = {
    .handle = "libaw_oggdec.so",
    .name   = "cedarogg",
    .init   = STRING(ADEC_OGG_INIT_FUNC), //"AudioOGGDecInit",
    .exit   = STRING(ADEC_OGG_EXIT_FUNC), //"AudioOGGDecExit",
    .flag   = AD_CEDAR_CTRL_FLAG_BUILD_COMMONHDR,
};
...
InitCodecInfo InitAmrDecT = {
    ...
    .name   = "cedaramr",
    .init   = STRING(ADEC_AMR_INIT_FUNC), //"AudioAMRDecInit",
    .exit   = STRING(ADEC_AMR_EXIT_FUNC), //"AudioAMRDecExit",
    .flag   = AD_CEDAR_CTRL_FLAG_BUILD_AMRHDR,
};
InitCodecInfo InitFlacDecT = {
    .handle = "libaw_flacdec.so",
    .name   = "cedarflac",
    .init   = STRING(ADEC_FLAC_INIT_FUNC), //"AudioFLACDecInit",
    .exit   = STRING(ADEC_FLAC_EXIT_FUNC), //"AudioFLACDecExit",
    .flag   = AD_CEDAR_CTRL_FLAG_BUILD_COMMONHDR,
};
...
InitCodecInfo InitRaDecT = {
    ...
    .name   = "cedarra",
    .init   = STRING(ADEC_RA_INIT_FUNC), //"AudioRADecInit",
    .exit   = STRING(ADEC_RA_EXIT_FUNC), //"AudioRADecExit",
    .flag   = AD_CEDAR_CTRL_FLAG_BUILD_COMMONHDR,
};
InitCodecInfo InitAlacDecT = {
    .handle = "libaw_alacdec.so",
    .name   = "cedaralac",
    .init   = STRING(ADEC_ALAC_INIT_FUNC), //"AudioALACDecInit",
    .exit   = STRING(ADEC_ALAC_EXIT_FUNC), //"AudioALACDecExit",
    .flag   = AD_CEDAR_CTRL_FLAG_BUILD_COMMONHDR,
};
InitCodecInfo InitG729DecT = {
    .handle = "libaw_g729dec.so",
    .name   = "cedarg729",
    .init   = STRING(ADEC_G729_INIT_FUNC), //"AudioG729DecInit",
    .exit   = STRING(ADEC_G729_EXIT_FUNC), //"AudioG729DecExit",
    .flag   = 0,
};
...
InitCodecInfo InitOpusDecT = {
    ...
    .name   = "cedaropus",
    .init   = STRING(ADEC_Opus_INIT_FUNC), //"AudioOpusDecInit",
    .exit   = STRING(ADEC_Opus_EXIT_FUNC), //"AudioOpusDecExit",
    .flag   = AD_CEDAR_CTRL_FLAG_BUILD_OPUSHDR,
};

InitCodecInfo InitWVDecT = {
    .handle = "libaw_wvdec.so",
    .name   = "cedarWV",
    .init   = STRING(ADEC_WV_INIT_FUNC), //"AudioWVDecInit",
    .exit   = STRING(ADEC_WV_EXIT_FUNC), //"AudioWVDecExit",
    .flag   = 0,
};

//add by ganqiuye
InitCodecInfo InitDraDecT = {
    .handle = "libaw_dradec.so",
    .name   = "cedardra",
    .init   = "AudioDRADecInit",
    .exit   = "AudioDRADecExit",
    .flag   = 0,
};
...
enum AUDIO_CODEC_INDEX
{
    ...
    AUDIO_CODEC_INDEX_WV,
    AUDIO_CODEC_INDEX_DRA,
};

/////////////////////Cedar Codecs Array Defined End Here///////////////////////
//#define __AD_CEDAR_DBG_WRITEOUT_BITSTREAM
...
{
#if !defined(CONFIG_ADEC_CONFIG_COMPILE_STATIC_LIB) || (0==CONFIG_ADEC_CONFIG_COMPILE_STATIC_LIB)
    (void)libname;
...
static int InitCodec(AudioDecoderContextLib* pAudioDecodeLib, InitCodecInfo* initcodecinfo)
{
    ...
    else if(0 == strcmp(initcodecinfo->init, STRING(ADEC_APE_INIT_FUNC)))
    {
        DECLARE_ADEC_INIT_FUNC(ADEC_APE_INIT_FUNC); //extern struct __AudioDEC_AC320 *AudioAPEDecInit(void);
        DECLARE_ADEC_EXIT_FUNC(ADEC_APE_EXIT_FUNC); //extern int AudioAPEDecExit(struct __AudioDEC_AC320 *p);
        pAudioDecodeLib->pCedarCodec->init = &ADEC_APE_INIT_FUNC; //&AudioAPEDecInit;
        pAudioDecodeLib->pCedarCodec->exit = &ADEC_APE_EXIT_FUNC; //&AudioAPEDecExit;
    }
    //else if(0 == strcmp(initcodecinfo->init, STRING(ADEC_COOK_INIT_FUNC)))
    //{
    //    DECLARE_ADEC_INIT_FUNC(ADEC_COOK_INIT_FUNC); //extern struct __AudioDEC_AC320 *AudioCOOKDecInit(void);
    //    DECLARE_ADEC_EXIT_FUNC(ADEC_COOK_EXIT_FUNC); //extern int AudioCOOKDecExit(struct __AudioDEC_AC320 *p);
    //    pAudioDecodeLib->pCedarCodec->init = &ADEC_COOK_INIT_FUNC; //&AudioCOOKDecInit;
    //    pAudioDecodeLib->pCedarCodec->exit = &ADEC_COOK_EXIT_FUNC; //&AudioCOOKDecExit;
    //}
    //else if(0 == strcmp(initcodecinfo->init, STRING(ADEC_SIPR_INIT_FUNC)))
    //{
    //    DECLARE_ADEC_INIT_FUNC(ADEC_SIPR_INIT_FUNC); //extern struct __AudioDEC_AC320 *AudioSIPRDecInit(void);
    //    DECLARE_ADEC_EXIT_FUNC(ADEC_SIPR_EXIT_FUNC); //extern int AudioSIPRDecExit(struct __AudioDEC_AC320 *p);
    //    pAudioDecodeLib->pCedarCodec->init = &ADEC_SIPR_INIT_FUNC; //&AudioSIPRDecInit;
    //    pAudioDecodeLib->pCedarCodec->exit = &ADEC_SIPR_EXIT_FUNC; //&AudioSIPRDecExit;
    //}
    //else if(0 == strcmp(initcodecinfo->init, STRING(ADEC_ATRC_INIT_FUNC)))
    //{
    //    DECLARE_ADEC_INIT_FUNC(ADEC_ATRC_INIT_FUNC); //extern struct __AudioDEC_AC320 *AudioATRCDecInit(void);
    //    DECLARE_ADEC_EXIT_FUNC(ADEC_ATRC_EXIT_FUNC); //extern int AudioATRCDecExit(struct __AudioDEC_AC320 *p);
    //    pAudioDecodeLib->pCedarCodec->init = &ADEC_ATRC_INIT_FUNC; //&AudioATRCDecInit;
    //    pAudioDecodeLib->pCedarCodec->exit = &ADEC_ATRC_EXIT_FUNC; //&AudioATRCDecExit;
    //}
    else if(0 == strcmp(initcodecinfo->init, STRING(ADEC_OGG_INIT_FUNC)))
    {
        DECLARE_ADEC_INIT_FUNC(ADEC_OGG_INIT_FUNC); //extern struct __AudioDEC_AC320 *AudioOGGDecInit(void);
        DECLARE_ADEC_EXIT_FUNC(ADEC_OGG_EXIT_FUNC); //extern int AudioOGGDecExit(struct __AudioDEC_AC320 *p);
        pAudioDecodeLib->pCedarCodec->init = &ADEC_OGG_INIT_FUNC; //&AudioOGGDecInit;
        pAudioDecodeLib->pCedarCodec->exit = &ADEC_OGG_EXIT_FUNC; //&AudioOGGDecExit;
    }
    ...
    else if(0 == strcmp(initcodecinfo->init, STRING(ADEC_AMR_INIT_FUNC)))
    {
        DECLARE_ADEC_INIT_FUNC(ADEC_AMR_INIT_FUNC); //extern struct __AudioDEC_AC320 *AudioAMRDecInit(void);
        DECLARE_ADEC_EXIT_FUNC(ADEC_AMR_EXIT_FUNC); //extern int AudioAMRDecExit(struct __AudioDEC_AC320 *p);
        pAudioDecodeLib->pCedarCodec->init = &ADEC_AMR_INIT_FUNC; //&AudioAMRDecInit;
        pAudioDecodeLib->pCedarCodec->exit = &ADEC_AMR_EXIT_FUNC; //&AudioAMRDecExit;
    }
    //else if(0 == strcmp(initcodecinfo->init, STRING(ADEC_FLAC_INIT_FUNC)))
    //{
    //    DECLARE_ADEC_INIT_FUNC(ADEC_FLAC_INIT_FUNC); //extern struct __AudioDEC_AC320 *AudioFLACDecInit(void);
    //    DECLARE_ADEC_EXIT_FUNC(ADEC_FLAC_EXIT_FUNC); //extern int AudioFLACDecExit(struct __AudioDEC_AC320 *p);
    //    pAudioDecodeLib->pCedarCodec->init = &ADEC_FLAC_INIT_FUNC; //&AudioFLACDecInit;
    //    pAudioDecodeLib->pCedarCodec->exit = &ADEC_FLAC_EXIT_FUNC; //&AudioFLACDecExit;
    //}
    ...
    else if(0 == strcmp(initcodecinfo->init, STRING(ADEC_RA_INIT_FUNC)))
    {
        DECLARE_ADEC_INIT_FUNC(ADEC_RA_INIT_FUNC); //extern struct __AudioDEC_AC320 *AudioRADecInit(void);
        DECLARE_ADEC_EXIT_FUNC(ADEC_RA_EXIT_FUNC); //extern int AudioRADecExit(struct __AudioDEC_AC320 *p);
        pAudioDecodeLib->pCedarCodec->init = &ADEC_RA_INIT_FUNC; //&AudioRADecInit;
        pAudioDecodeLib->pCedarCodec->exit = &ADEC_RA_EXIT_FUNC; //&AudioRADecExit;
    }
    else if(0 == strcmp(initcodecinfo->init, STRING(ADEC_ALAC_INIT_FUNC)))
    {
        DECLARE_ADEC_INIT_FUNC(ADEC_ALAC_INIT_FUNC); //extern struct __AudioDEC_AC320 *AudioALACDecInit(void);
        DECLARE_ADEC_EXIT_FUNC(ADEC_ALAC_EXIT_FUNC); //extern int AudioALACDecExit(struct __AudioDEC_AC320 *p);
        pAudioDecodeLib->pCedarCodec->init = &ADEC_ALAC_INIT_FUNC; //&AudioALACDecInit;
        pAudioDecodeLib->pCedarCodec->exit = &ADEC_ALAC_EXIT_FUNC; //&AudioALACDecExit;
    }
    //else if(0 == strcmp(initcodecinfo->init, STRING(ADEC_G729_INIT_FUNC)))
    //{
    //    DECLARE_ADEC_INIT_FUNC(ADEC_G729_INIT_FUNC); //extern struct __AudioDEC_AC320 *AudioG729DecInit(void);
    //    DECLARE_ADEC_EXIT_FUNC(ADEC_G729_EXIT_FUNC); //extern int AudioG729DecExit(struct __AudioDEC_AC320 *p);
    //    pAudioDecodeLib->pCedarCodec->init = &ADEC_G729_INIT_FUNC; //&AudioG729DecInit;
    //    pAudioDecodeLib->pCedarCodec->exit = &ADEC_G729_EXIT_FUNC; //&AudioG729DecExit;
    //}
    else if(0 == strcmp(initcodecinfo->init, STRING(ADEC_Opus_INIT_FUNC)))
    {
        DECLARE_ADEC_INIT_FUNC(ADEC_Opus_INIT_FUNC); //extern struct __AudioDEC_AC320 *AudioOpusDecInit(void);
        DECLARE_ADEC_EXIT_FUNC(ADEC_Opus_EXIT_FUNC); //extern int AudioOpusDecExit(struct __AudioDEC_AC320 *p);
        pAudioDecodeLib->pCedarCodec->init = &ADEC_Opus_INIT_FUNC; //&AudioOpusDecInit;
        pAudioDecodeLib->pCedarCodec->exit = &ADEC_Opus_EXIT_FUNC; //&AudioOpusDecExit;
    }
    //else if(0 == strcmp(initcodecinfo->init, STRING(ADEC_WV_INIT_FUNC)))
    //{
    //    DECLARE_ADEC_INIT_FUNC(ADEC_WV_INIT_FUNC); //extern struct __AudioDEC_AC320 *AudioWVDecInit(void);
    //    DECLARE_ADEC_EXIT_FUNC(ADEC_WV_EXIT_FUNC); //extern int AudioWVDecExit(struct __AudioDEC_AC320 *p);
    //    pAudioDecodeLib->pCedarCodec->init = &ADEC_WV_INIT_FUNC; //&AudioWVDecInit;
    //    pAudioDecodeLib->pCedarCodec->exit = &ADEC_WV_EXIT_FUNC; //&AudioWVDecExit;
    //}
    else
    {
...
static const char* CodecIDtoFormatName(enum EAUDIOCODECFORMAT ecodec)
{
    switch(ecodec){
        ...
        case AUDIO_CODEC_FORMAT_OPUS:
            return "opus";
        case AUDIO_CODEC_FORMAT_WV:
            return "WV";
        case AUDIO_CODEC_FORMAT_DRA:
            return "DRA";
        default:
...
*/
    ...
    if(pAudioDecodeLib->pCedarCodec->flag & AD_CEDAR_CTRL_FLAG_BUILD_OPUSHDR)
    {
        if(pExtraData && nExtraDataLen > 0)
        {
            alib_logd("nExtraDataLen=%d", nExtraDataLen);
            pAudioDecodeLib->pCedarAudioDec->extradata_size = nExtraDataLen;
            pAudioDecodeLib->pCedarAudioDec->extradata = (char*)calloc(1,nExtraDataLen);
            if(pAudioDecodeLib->pCedarAudioDec->extradata == NULL)
            {
                alib_loge("malloc failed, len=%d", nExtraDataLen);
                return -1;
            }
            memcpy(pAudioDecodeLib->pCedarAudioDec->extradata, pExtraData, nExtraDataLen);
        }
    }
...
static void AC320DecExit(AudioDecoderContextLib *pAudioDecodeLib)
{
    ...
    {
        if((pAudioDecodeLib->pCedarCodec->flag & AD_CEDAR_CTRL_FLAG_BUILD_OPUSHDR)
            && pAudioDecodeLib->pCedarAudioDec->extradata != NULL)
        {
            free(pAudioDecodeLib->pCedarAudioDec->extradata);
            pAudioDecodeLib->pCedarAudioDec->extradata = NULL;
        }
                           ...
                           BsInFor *pBsInFor)
{
    ...
    InitCodecInfo InitDecTArrayDolby[] = {
        #if defined(AUTH_T)
        InitDolbyDecT,
        #else
        InitDolbyPassThru,
    ...
    int DolbyArraySize = sizeof(InitDecTArrayDolby) / sizeof(InitCodecInfo);
    AudioDecoderContextLib *pAudioDecodeLib            = (AudioDecoderContextLib *)pDecoder;
    pAudioDecodeLib->DecFileInfo.tmpGlobalAudioDecData = (void*)pDecoder;
    pAudioDecodeLib->nAudioInfoFlags                  = pAudioStreamInfo->nFlags;
    alib_logd("**** InitializeAudioDecodeLib codec_tpye:%d ****",pAudioStreamInfo->eCodecFormat);

    switch(pAudioStreamInfo->eCodecFormat)
    {
        case AUDIO_CODEC_FORMAT_AC3:
            idx = 0;
            while(idx < DolbyArraySize){
                ret = InitCodec(pAudioDecodeLib, &InitDecTArrayDolby[idx++]);
                if(ret >= 0)
                    break;
            }
            if(ret < 0)
            ...
            break;
        case AUDIO_CODEC_FORMAT_DTS:
            ret = InitCodec(pAudioDecodeLib, InitCodesT[AUDIO_CODEC_INDEX_DTS]);
            if(ret < 0)
            {
                ExitCodec(pAudioDecodeLib);
                return -1;
        ...
        case AUDIO_CODEC_FORMAT_WV:
        {
            ret = InitCodec(pAudioDecodeLib, InitCodesT[AUDIO_CODEC_INDEX_WV]);
            if(ret < 0)
            {
                ExitCodec(pAudioDecodeLib);
                return -1;
        ...
        case AUDIO_CODEC_FORMAT_DRA:
        {
            ret = InitCodec(pAudioDecodeLib, InitCodesT[AUDIO_CODEC_INDEX_DRA]);
            if(ret < 0)
            {
                ExitCodec(pAudioDecodeLib);
                return -1;
                      ...
                      int*          pBufSize)
{
    AudioDecoderContextLib *pAudioDecodeLib  = (AudioDecoderContextLib *)pDecoder;
    int ret = 0;
    //alib_loge("***LINE:%d,DEC init, ppBuf = 0x%08x, pBufSize = %d",__LINE__, ppBuf, pBufSize);
    ret = pAudioDecodeLib->pCedarAudioDec->DecFrame(pAudioDecodeLib->pCedarAudioDec, (alib_int8*)ppBuf, pBufSize);
    //alib_loge("***DEC :ret:%d,len:%d,fs:%d,ch:%d\n",ret,*pBufSize,pAudioDecodeLib->pCedarAudioDec->BsInformation->Samplerate,pAudioDecodeLib->pCedarAudioDec->BsInformation->chan);
#ifdef __AD_CEDAR_DBG_WRITEOUT_PCM_BUFFER
    if(pFilePcm)
...
int CheckAudioVersion(void* audioVersion)
{
    if(audioVersion)
    {
        if(!strncmp(audioVersion, "adbac52f9a9871357a1c4912610edad40f87d473", 40))
            return 0;
    }
    else
    {
        alib_loge("CheckAudioVersion:audioVersion is NULL.");
    }
