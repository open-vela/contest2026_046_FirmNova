...
#ifdef CONFIG_ASF_PARSER_ENABLE
...
#ifdef CONFIG_AVI_PARSER_ENABLE
...
#ifdef CONFIG_FLV_PARSER_ENABLE
...
#ifdef CONFIG_MOV_PARSER_ENABLE
...
#ifdef CONFIG_HLS_PARSER_ENABLE
...
#ifdef CONFIG_MKV_PARSER_ENABLE
...
#ifdef CONFIG_MPG_PARSER_ENABLE
...
#ifdef CONFIG_PMP_PARSER_ENABLE
...
#ifdef CONFIG_OGG_PARSER_ENABLE
...
#ifdef CONFIG_APE_PARSER_ENABLE
...
#endif
#ifdef CONFIG_FLAC_PARSER_ENABLE
...
#ifdef CONFIG_AMR_PARSER_ENABLE
...
#ifdef CONFIG_MP3_PARSER_ENABLE
...
#ifdef CONFIG_WAV_PARSER_ENABLE
...
#ifdef CONFIG_AAC_PARSER_ENABLE
...
#ifdef CONFIG_ID3V2_PARSER_ENABLE
...
#ifdef CONFIG_PLS_PARSER_ENABLE
...
#ifdef CONFIG_ATRAC_PARSER_ENABLE
