...
const cdx_int32 cdx_ff_mpeg4audio_sample_rates[16] = {
...
cdx_int32 matroska_aac_sri (cdx_int32 samplerate)
{
    ...
    for (sri=0; sri<ARRAY_SIZE(cdx_ff_mpeg4audio_sample_rates); sri++)
        if (cdx_ff_mpeg4audio_sample_rates[sri] == samplerate)
            break;
    return sri;
}
