...
#define CDX_IOT_CACHE_SUPPORT  0

#define BAND_WIDTH_RECORD_NUMBER  100
...
typedef struct CdxHttpStreamImpl
{
    ...
    int setBufferFlag;
    pthread_mutex_t setBufferMutex;
    pthread_cond_t setBufferCond;
#endif
    ...
    BandwidthEntryT bandWidthHistory[BAND_WIDTH_RECORD_NUMBER];
    cdx_int32 index;
#else
    cdx_int32 count;
    cdx_int32 tmpTotalBytes;
    cdx_int64 tmpTotalTimeUs;
#endif
