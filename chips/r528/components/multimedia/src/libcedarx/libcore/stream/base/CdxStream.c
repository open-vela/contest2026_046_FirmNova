...
#include <CdxList.h>
#include <debug.h>
#define sprintk _info

#define WHT_DBG(fmt, ...)           do{ sprintk("%s line %d, "fmt, __func__, __LINE__, ##__VA_ARGS__); } while(0)
#define WHT_BUG()                   do{ WHT_DBG("BUG happend!\n"); }while(0)
