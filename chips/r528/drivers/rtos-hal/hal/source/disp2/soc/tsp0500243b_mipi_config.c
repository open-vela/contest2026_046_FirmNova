    ...
    },
{
        .name = "lcd_ht",
        .type = PROPERTY_INTGER,
        .v.value = 1130,  // 水平总计 (800+160+160+10=1130)
    },
    {
        .name = "lcd_hbp",
        .type = PROPERTY_INTGER,
    ...
    },
    {
        .name = "lcd_vt",
        .type = PROPERTY_INTGER,
        .v.value = 516,   // 垂直总计 (480+23+12+1=516)
    },
    {
        .name = "lcd_vbp",
        .type = PROPERTY_INTGER,
    ...
    // 背光PWM配置
{
    ...
    #if 1 // 如果使用GT911触摸屏，则启用以下GPIO配置(在触摸屏驱动中已重复定义，所以此处注释掉)
    {
        .name = "lcd_gpio_1", // 触摸屏复位信号 (CTP_RST)-BIST
        .type = PROPERTY_GPIO,
        .v.gpio_list = {
            .gpio_name = "PB4",
            .port = 1,            // GPIOB是端口1
    ...
    {
        .name = "lcd_gpio_2", // 触摸屏中断信号 (CTP_INT)-STBYB
        .type = PROPERTY_PIN,
        .v.gpio_list = {
            .gpio_name = "PB5",
            .port = 1,            // GPIOB是端口1
    ...
    },
{
        .name = "lcd_size",
        .type = PROPERTY_STRING,
        .v.str = "800x480",  // 屏幕尺寸字符串
    },
    {
        .name = "lcd_model_name",
        .type = PROPERTY_STRING,
        .v.str = "TSP0500243B",  // 屏幕型号名称
    },
};
