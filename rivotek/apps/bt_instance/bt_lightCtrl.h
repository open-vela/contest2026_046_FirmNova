 ...
 ***************************************************************************/
#ifndef __BT_LIGHTCTRL_H__
#define __BT_LIGHTCTRL_H__
/****************************************************************************
 * Included Files
 ****************************************************************************/
#ifdef LOG_TAG
...
// extern int do_light_ctrl(uint16_t lightness, uint16_t temp);
// extern int do_light_connect();
...
int do_light_ctrl(float light_perc);//internal interface
