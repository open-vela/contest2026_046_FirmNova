 ...
 * src_sample_rate: actual sample rate of incoming data (for resampling).
 *                   Set to sample_rate to bypass resampling.
 ...
 * Stops the underlying NxPlayer and marks the handle so that subsequent
 * write() calls return -ECANCELED immediately.
